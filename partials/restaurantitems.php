<div class="de-breadcrumb">
	...
	<div class="de-options">
		<a href="<?php echo path ?>/restaurant.php?pg=items&request=new" class="de-btn"><i class="fas fa-plus"></i> <?=$lang['restaurant']['it_new']?></a>
	</div>
	<?php endif; ?>
	<?php endif; ?>
</div>
				...
				<tr>
					...
					<td class="de-dot-options">
						...
						<ul class="de-drop">
							...
							<li><a href="#" class="de-delete" data-type="item" data-id="<?=$rs['id']?>"><i class="fas fa-trash-alt"></i> <?=$lang['restaurant']['de_delete']?></a></li>
						</ul>
					</td>
				</tr>
				<?php endwhile; ?>
