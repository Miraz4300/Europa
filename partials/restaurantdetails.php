<div class="de-breadcrumb">
	...
	<div class="de-options">
		<a href="<?php echo path ?>/restaurant.php?pg=details&request=new" class="de-btn"><i class="fas fa-plus"></i> <?=$lang['restaurant']['de_new']?></a>
	</div>
	<?php endif; ?>
</div>

<div class="de-resaurants de-restaurantspage">
	<div class="de-resaurant">
      ...
      <div class="modal-body">
		        ...
		        <div class="form-group">
				  ...
				  <div class="tab-pane container" id="menu2">
				  	<input id="images" name="images[]" type="file" multiple>
						<div class="de-image-append">
							...
							?>
							<div>
								<span class="de-select-profile bg-o de-btn tips"><i class="fas fa-user"></i><b><?=$lang['restaurant']['de_profile']?></b></span>
								<span class="de-select-cover bg-gr de-btn tips"><i class="fas fa-image"></i><b><?=$lang['restaurant']['de_cover']?></b></span>
								<span class="de-select-delete bg-gy de-btn tips"><i class="fas fa-trash-alt"></i><b><?=$lang['restaurant']['de_delete']?></b></span>
				  ...
				  <div class="tab-pane container" id="menu3">
						<div class="form-group">
							<label><?=$lang['restaurant']['de_hours']?>:</label>
      ...
      <div class="modal-footer">
        <button type="submit" class="de-btn"><?=$lang['send']?></button>
		...
		<?php else: ?>
			...
			<table class="table">
				...
				<tbody>
					...
					?>
					<tr>
						<th width="1"><div class="de-thumb m-0"><img src="<?=path?>/<?=$rs['photo']?>" alt="<?=$rs['name']?>" onerror="this.src='<?=noimage?>'"></div></th>
						<td width="40%">
						...
						<td class="de-dot-options">
							<a class="de-options-link"><i class="fas fa-ellipsis-h"></i></a>
							<ul class="de-drop">
								...
								<li><a href="#" class="de-delete-survey" rel="<?=$rs['id']?>"><i class="fas fa-trash-alt"></i> <?=$lang['restaurant']['de_delete']?></a></li>
							</ul>
						</td>
					</tr>
					<?php endwhile; ?>
