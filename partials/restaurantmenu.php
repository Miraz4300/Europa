<div class="de-breadcrumb">
	<div class="de-title"><i class="icon-layers icons ic"></i> <?=$lang['restaurant']['menu_title']?></div>
	<?php if (fh_access('menus')): ?>
	<div class="de-options">
		<a data-toggle="modal" href="#myModal" class="de-btn"><i class="fas fa-plus"></i> <?=$lang['restaurant']['new_menu']?></a>
	</div>
	<?php endif; ?>
</div>
				...
				<tr>
					...
					<td class="de-dot-options">
						...
						<ul class="de-drop">
							...
							<li><a data-toggle="modal" href="#myModal" class="de-editmenulink" data-id="<?=$rs['id']?>"><i class="far fa-edit"></i> <?=$lang['restaurant']['de_edit']?></a></li>
							<li><a href="#" class="de-delete" data-type="menu" data-id="<?=$rs['id']?>"><i class="fas fa-trash-alt"></i> <?=$lang['restaurant']['de_delete']?></a></li>
						</ul>
					</td>
				</tr>
				<?php endwhile; ?>
