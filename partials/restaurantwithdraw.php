<div class="de-breadcrumb">
	<div class="de-title"><i class="fas fa-hand-holding-usd ic"></i> <?=$lang['dash']['withdraw']?></div>
	<div class="de-options">
		<a data-toggle="modal" href="#myModal" class="de-btn"><i class="fas fa-plus"></i> <?=$lang['restaurant']['new_withdraw']?></a>
	</div>
</div>
