...
<div class="de-resaurants de-restaurantspage">
    ...
    <div class="form-group">
		...
		<div class="mb-4">
			<h6 class="de-addSize"><?=$lang['restaurant']['sizes']?> <i class="fas fa-plus-circle"></i></h6>
						...
						<div class="form-row">
							...
							<div class="col-4">
								<div class="form-group">
									...
									<i class="fas fa-minus-circle de-removeSize"></i>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="mb-4">
			<h6 class="de-addExtra"><?=$lang['restaurant']['extra']?> <i class="fas fa-plus-circle"></i></h6>
						...
						<div class="form-row">
							...
							<div class="col-4">
								<div class="form-group">
									...
									<i class="fas fa-minus-circle de-removeExtra"></i>
								</div>
							</div>
						</div>
					</div>
    ...
    <div class="modal-footer">
      <button type="submit" class="de-btn"><?=$lang['restaurant']['btn']?></button>
