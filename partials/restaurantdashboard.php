...
?>
	<?php if ($rs_rest): ?>
	<div class="de-restohead">
		<div class="media">
			<div class="media-left"><div class="de-thumb"><img src="<?php echo $rs_rest['photo'] ?>" onerror="this.src='<?=noimage?>'"></div></div>
			<div class="media-body">
				<div class="de-dtable">
					<div class="de-vmiddle">
						<div class="de-title"><a href="<?php echo path ?>/restaurants.php?id=<?php echo $rs_rest['id'] ?>&t=<?php echo fh_seoURL($rs_rest['name']) ?>"><h3><?php echo $rs_rest['name'] ?></h3></a></div>
						<div class="de-stars"><?php echo fh_stars($rs_rest['id'], "restaurant") ?></div>
					</div>
				</div>
			</div>
		</div>
