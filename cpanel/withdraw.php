		...
		<tbody>
			...
			<tr>
				<td width="40%">
					...
					<a href="#" class="de-name"><?=fh_user($rs['author'])?></a>
				</td>
				...
				<td class="de-dot-options">
					...
					<ul class="de-drop">
						<li><a href="#" class="de-accept" data-id="<?=$rs['id']?>"><i class="fas fa-check"></i> <?=$lang['dash']['accept']?></a></li>
						<li><a href="#" class="de-refuse" data-id="<?=$rs['id']?>"><i class="fas fa-times"></i> <?=$lang['dash']['refuse']?></a></li>
					</ul>
				</td>
			</tr>
			<?php
