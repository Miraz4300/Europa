<div class="de-breadcrumb">
	...
	<div class="de-options">
		<a href="<?=path?>/dashboard.php?pg=pages&request=new" class="de-btn"><i class="fas fa-plus"></i> Create a Page</a>
	</div>
</div>
					...
					<tr>
						...
						<td class="de-dot-options">
							...
							<ul class="de-drop">
								...
								<li><a href="#" class="de-delete" data-id="<?=$rs['id']?>" data-type="page"><i class="fas fa-trash-alt"></i> Delete</a></li>
							</ul>
						</td>
					</tr>
					<?php endwhile; ?>
...
<div class="de-box">
	<form id="sendpage">
		...
		<hr>
		<button type="submit" class="de-btn">Submit</button>
