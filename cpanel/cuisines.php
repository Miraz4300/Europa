<div class="de-breadcrumb">
	...
	<div class="de-options">
		<a data-toggle="modal" href="#myModal" class="de-btn"><i class="fas fa-plus"></i> Create a Cuisine</a>
	</div>
</div>
	...
	<div class="de-resaurant">
		<table class="table">
			...
			<tbody>
				...
				?>
				<tr>
					<th width="1"><div class="de-thumb"><img src="<?=path?>/<?=$rs['image']?>" alt="<?=$rs['name']?>" onerror="this.src='<?=noimage?>'"></div></th>
					<td width="40%">
					...
					<td class="de-dot-options">
						...
						<ul class="de-drop">
							<li><a data-toggle="modal" href="#myModal" class="de-editcuisinelink" data-id="<?=$rs['id']?>"><i class="far fa-edit"></i> Edit</a></li>
							<li><a href="#" class="de-delete" data-type="cuisine" data-id="<?=$rs['id']?>"><i class="fas fa-trash-alt"></i> Delete</a></li>
						</ul>
					</td>
				</tr>
				<?php endwhile; ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
				<div class="form-group de-imginp">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="de-btn">Send</button>
      </div>
    </div>
  </div>
</div>
