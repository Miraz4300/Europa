<div class="de-breadcrumb">
	...
	<div class="de-options">
		<a data-toggle="modal" href="#myModal" class="de-btn"><i class="fas fa-plus"></i> Create a Menu</a>
	</div>
</div>
	...
	<div class="de-resaurant">
		...
		<table class="table">
			...
			<tbody>
				...
				?>
				<tr>
					<th width="1"><div class="de-thumb"><img src="<?=path?>/<?=$rs['photo']?>" alt="<?=$rs['rname']?>" onerror="this.src='<?=noimage?>'"></div></th>
					<td width="40%">
					...
					<td class="de-dot-options">
						...
						<ul class="de-drop">
							...
							<li><a data-toggle="modal" href="#myModal" class="de-editmenulink" data-id="<?=$rs['id']?>"><i class="far fa-edit"></i> Edit</a></li>
							<li><a href="#" class="de-delete" data-type="menu" data-id="<?=$rs['id']?>"><i class="fas fa-trash-alt"></i> Delete</a></li>
						</ul>
					</td>
				</tr>
				<?php endwhile; ?>
