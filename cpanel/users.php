...
<div class="de-breadcrumb">
	...
	<div class="de-options">
		<a href="#myModal" data-toggle="modal" class="de-btn"><i class="fas fa-plus"></i> <?=$lang['dash']['u_create']?></a>
	</div>
</div>
		...
		<tbody>
			...
			<tr>
				<td width="40%">
					...
					<a href="#" class="de-name"><?=$rs['username']?></a>
				</td>
				...
				<td class="de-dot-options">
					...
					<ul class="de-drop">
						...
						<li><a href="#" class="de-delete" data-id="<?=$rs['id']?>" data-type="user"><i class="fas fa-trash-alt"></i> <?=$lang['dash']['delete']?></a></li>
					</ul>
				</td>
			</tr>
			<?php
