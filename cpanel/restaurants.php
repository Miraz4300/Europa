...
<div class="de-breadcrumb">
	...
	<div class="de-options">
		<a href="<?=path?>/dashboard.php?pg=restaurants&request=new" class="de-btn"><i class="fas fa-plus"></i> <?=$lang['restaurant']['de_new']?></a>
	</div>
</div>
	...
	<div class="de-resaurant">
		...
		<table class="table">
			...
			<tbody>
				...
				?>
				<tr>
					<th width="1"><div class="de-thumb"><img src="<?=path?>/<?=$rs['photo']?>" alt="<?=$rs['name']?>" onerror="this.src='<?=noimage?>'"></div></th>
					<td>
					...
					<td class="de-dot-options">
						...
						<ul class="de-drop">
							...
							<li><a href="#" class="de-delete" data-id="<?=$rs['id']?>" data-type="restaurant"><i class="fas fa-trash-alt"></i> <?=$lang['dash']['delete']?></a></li>
						</ul>
					</td>
				</tr>
				<?php endwhile; ?>
