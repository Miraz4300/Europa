...
<div class="de-resaurants de-restaurantpage">
					...
					<div class="de-dtable">
						<div class="de-vmiddle">
							...
							<div class="de-options">
								<?php if($rs['status']==2): ?>
								<a class="de-delivered wdth"><i class="fas fa-check"></i> Delivered</a>
								<?php elseif($rs['status']==1): ?>
								<a class="de-awaiting wdth bg-v"><i class="fas fa-truck"></i> In the way</a>
								<?php else: ?>
								<a class="de-awaiting wdth"><i class="fas fa-clock"></i> Awaiting</a>
								<?php endif; ?>
								<?php if($rs['status']!=2): ?>
								<a href="#" class="de-delivered tips" data-id="<?php echo $rs['id'] ?>"><i class="fas fa-check"></i><b>Make it delivered</b></a>
								<?php endif; ?>
								<?php if($rs['status']==0): ?>
								<a href="#" class="de-intheway tips" data-id="<?php echo $rs['id'] ?>"><i class="fas fa-truck"></i><b>In the way</b></a>
								<?php endif; ?>
								<a href="#" class="de-addinvoice tips" data-name="<?php echo time()."_".fh_seoURL($rsi['name']); ?>" data-id="<?php echo $rs['id']; ?>"><i class="fas fa-file-invoice-dollar"></i><b>Invoice</b></a>
